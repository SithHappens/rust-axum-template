...
/// Routing the RPC functions.
///
/// The first routing is on the URL/path. Here the routing is on the body, we need to get the
/// method name from the body.
async fn rpc_handler(
    ...
    // Execute and store RpcInfo in the response
